...
function SocialMedia() {
    return (
        <div className={styles.iconContainer}>
            ...
            <Link target="_blank" to={'https://www.youtube.com/channel/UCQ5zQ7QyQG2O5c4z3Y0zQ7Q'} className={`icon ${styles.icon}`}><img src="./images/icons/linkedin.png" alt="social media" /></Link>
        </div>
    );
}
